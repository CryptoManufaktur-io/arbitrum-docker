...
Examples:
  ./check_sync.sh --public-rpc https://arbitrum.drpc.org
  ./check_sync.sh --compose-service nitro --public-rpc https://arbitrum.drpc.org
  CONTAINER=nitro-1 PUBLIC_RPC=https://arbitrum.drpc.org ./check_sync.sh
EOF
}
